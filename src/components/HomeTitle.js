...
export default function HomeTitle() {
    return(
        <div className='hometitle'>
            <div className='hometitle-picture-borders hometitle-picture-borders_dimensions hometitle-picture-borders_borders'><img src={picture_eric_murh} alt="bord de mer" className='hometitle-picture' /></div>
